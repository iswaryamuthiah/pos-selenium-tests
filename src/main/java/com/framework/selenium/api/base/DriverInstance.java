...
public class DriverInstance{
	...
	public void setDriver(String browser, boolean headless) throws MalformedURLException {		
		...
		case "chrome":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://4.188.75.179:4444/wd/hub"), options));
			break;
		case "firefox":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://4.188.75.179:4444/wd/hub"), firefoxOptions));
			break;
		case "edge":
